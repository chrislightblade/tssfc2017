...
public class Casa_aste {
    ...
    private ArrayList<Oggetto> oggettiAllAsta ;
    
    public Casa_aste() {

        oggettiAllAsta = new ArrayList<Oggetto>();
    ...
    public String getOggettiAllAsta() {
        ...
        for (int i = 0; i < oggettiAllAsta.size(); i++) {
            report += (i + 1) + "°: " + oggettiAllAsta.get(i).getNome() + " valore d'asta: " + oggettiAllAsta.get(i).getOfferta() + "\nOfferente migliore: " + oggettiAllAsta.get(i).getMaggioreOfferente() + "\n";
        }
        return report;
    }
    ...
    public String getNomeOggettiAllAsta() {
        String report = "I seguenti oggetti sono all'asta:\n";
        for (int i = 0; i < oggettiAllAsta.size(); i++) {
            report += (i + 1) + "°: " + oggettiAllAsta.get(i).getNome() + "\n";
        }
        return report;
    }
    ...
    public void setOggettiAllAsta() {
        String report = "I seguenti oggetti sono all'asta:\n";
        for (int i = 0; i < oggettiAllAsta.size(); i++) {
            report += oggettiAllAsta.get(i).getNome() + " valore d'asta: " + oggettiAllAsta.get(i).getOfferta() + "\n";
        }
        ...
        if (input == 0) {
            ...
            while (verifica == false) {
                ...
                try {
                    if (!report2.equalsIgnoreCase("")) {
                        input2 = Integer.parseInt(report2);
                        if (input2 <= oggettiAllAsta.size() && input != 0) {
                            verifica = true;
                        } else {
                            JOptionPane.showMessageDialog(null, "non hai inserito dei valori validi");
                        }
            ...
            while (verifica == false) {
                input3 = 0;
                String report2 = JOptionPane.showInputDialog(persone.get(input).getNome() + " quanto desidera offrire per " + oggettiAllAsta.get(input2 - 1).getNome());
            ...
            String report = "L'offerta non è valida, più bassa dell'ultimo offerente, cioè " + oggettiAllAsta.get(input2 - 1).getOfferta();
            if (input3 > oggettiAllAsta.get(input2 - 1).getOfferta()) {
        ...
        for (int i = 0; i < oggettiAllAsta.size(); i++) {
            for (int j = 1; j < persone.size(); j++) {
                ...
                if (input > 0) {
                    ...
                    if (input > oggettiAllAsta.get(i).getOfferta()) {
    ...
    public void chiudiAsta() {
        ...
        for (int i = 0; i < oggettiAllAsta.size(); i++) {
            if (oggettiAllAsta.get(i).getMaggioreOfferente().equalsIgnoreCase("nessuno") == false) {
                report += oggettiAllAsta.get(i).getNome() + " valore d'asta: " + oggettiAllAsta.get(i).getOfferta() + "\nOfferente migliore: " + oggettiAllAsta.get(i).getMaggioreOfferente() + "\n";
    ...
    public void stampaStorico() {
        ...
        while (control == false) {
            ...
            if (input == 0) {
                ...
                JOptionPane.showConfirmDialog(null, oggettiAllAsta.get(input - 1).getOfferte());
            }
        }
